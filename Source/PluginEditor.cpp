...
LightFingersAudioProcessorEditor(LightFingersAudioProcessor& p)
...
void LightFingersAudioProcessorEditor::paint(juce::Graphics& g)
{
    g.fillAll(juce::Colour(0xff110e0a));

    g.setColour(juce::Colour(0xffe4a52a));
    g.setFont(juce::Font(24.0f, juce::Font::bold));
    g.drawText("LIGHTFINGERS", 24, 16, 320, 32,
...
void LightFingersAudioProcessorEditor::resized()
{
...
void LightFingersAudioProcessorEditor::timerCallback()
{
    repaint();
}

void LightFingersAudioProcessorEditor::exportMidi()
{
    auto chooser = std::make_shared<juce::FileChooser>(
        "Export LIGHTFINGERS MIDI",
